...
function sunting(id) {
	...
	$.ajax({
		url: '../../admin/page/kategori-dokumen/get/' + id,
		type: 'GET',
		dataType: 'JSON',
...
function save_form() {
	var url = '';
	if (save_method == 'add') url = '../../admin/page/kategori-dokumen/insert';
	else url = '../../admin/page/kategori-dokumen/update';
...
function hapus(id) {
	Swal.fire({
		...
		if (result.value) {
			$.ajax({
				url: '../../admin/page/kategori-dokumen/delete/' + id,
				type: "GET",
				dataType: "JSON",
				success: function (data) {
					Swal.fire({
